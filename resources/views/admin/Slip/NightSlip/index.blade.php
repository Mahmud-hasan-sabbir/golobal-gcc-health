    ...
    <table class="table table-striped table-class" id="table-id">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $item['comments'] }}</td>
          <td>
            {{-- <a href="#myModal" role="button" data-toggle="modal"><i class="mdi mdi-eye"></i></a> --}}
            @if($item['has_send'] != 1)
            <button type="submit" data-id="{{ $item['id'] }}" onclick="NightSlip.edit($(this))" title="Edit"><i class="mdi mdi-circle-edit-outline"></i></button>
            <button type="submit" data-id="{{ $item['id'] }}" onclick="NightSlip.Send($(this))" title="Send"><i class="mdi mdi-send"></i></button>
            @else
            Action Done
            @endif
          </td>
