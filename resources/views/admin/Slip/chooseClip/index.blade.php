<div class="content">
    <div class="card">
      <div class="card-header">
        <h2 class="text-center">Choose Slip List</h2>
      </div>
      <div class="px-6 py-4 row">
        ...
        <div class="col-xl-3">
          <button type="button" class="mb-1 btn btn-pill btn-success" onclick="ChooseSlip.creatSlip()">+ Create Choose Slip</button>
        </div>
      </div>
    </div>
...
var ChooseSlip = {
    ...
    url = '{{route('chooseSlip.creatSlip')}}';
    data = {};
