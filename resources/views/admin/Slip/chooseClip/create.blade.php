        ...
        <div class="card-body">
            ...
            <form id="chooseSleep" class="row">
                ...
                <div class="form-group col-xl-12">
                    <label for="job_post">Hospital Name (হাসপাতাল নাম )</label>
                    <select class="form-control" id="job_post" name="job_post[]" multiple required>
                      <option value="">Select Position</option>
                      @foreach ($hospitalName as $item)
...
<script>
  ...
  $('#chooseSleep').on('submit',function(e){
    e.preventDefault();
    $('#loader').removeClass('hidden')
    let url = '{{route('chooseSlip.storeChooseSlip')}}';
    let data = $('#chooseSleep').serializeArray();
